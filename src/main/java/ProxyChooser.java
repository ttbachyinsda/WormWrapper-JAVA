...
public class ProxyChooser {
    ...
    public static void getnewproxy() {
        String index_url= "http://svip.kuaidaili.com/api/getproxy/?orderid=910224640141044&num=500&b_pcchrome=1&b_pcie=1&b_pcff=1&b_android=1&b_iphone=1&b_ipad=1&protocol=1&method=2&an_an=1&an_ha=1&quality=1&sep=1";
